# cores/readle.py (v2.0 - Two-Layer Scraping)
...
def scrape_manual(url: str) -> dict:
    """
    Extract content from URL using robust two-layer system.
    Layer 1: BeautifulSoup for manual scraping.
    Layer 2: Trafilatura as smart fallback.
    """
    proxies = {
        "http": "http://initditer89:initditer89@154.203.43.247:5536",
        "https": "http://initditer89:initditer89@154.203.43.247:5536"
    }
    headers = {
